							...
							<form:form modelAttribute="insert_dipendente_attr" method="post" action="save" novalidate="novalidate" class="row g-3">
								...
								<div class="col-md-6">
									...
									<spring:bind path="codiceFiscale">
										<input type="text" name="codiceFiscale" id="codiceFiscale" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il Codice Fiscale" value="${insert_dipendente_attr.codiceFiscale }" required>
									</spring:bind>
									<form:errors  path="codiceFiscale" cssClass="error_field" />
								</div>
								
								<input type="hidden"  name="email" id="email" value="${insert_dipendente_attr.email }" required>
								...
								<div class="col-md-6">	
										...
										<div class="form-group col-md-6">
											<label for="dataDimissioni" class="form-label">Data di Dimisisoni</label>
