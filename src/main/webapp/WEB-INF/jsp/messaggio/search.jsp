	  ...
	  <div class="container">
			...
			<div class='card'>
			    ...
			    <div class='card-body'>
						...
						<form:form modelAttribute="insert_messaggio_attr" method="post" action="${pageContext.request.contextPath}/messaggio/list" class="row g-3">
							...
							<div class="col-md-6">
								<label for="dataLettura" class="form-label">Data di Lettura</label>
